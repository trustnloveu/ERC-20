...
/*****************************************************************************************************************
    ...
    Cybersecurity In Solidity    - against bad actors, accidental occurances 
        ...
        called funders back to their wallets called contributedAmount. Add a modifier to the signature that only the owner can execute this function.
...
/*****************************************************************************************************************
    What could go wrong?
        ...
        What happens if Tatianna rejects the transfer? If Tatianna rejects the transfer the function is going to fail and then John will not get paid !!!

        Thinking that all contracts and accounts want to accept funds automatically may be intuitive at first but it is in fact very naive and very dangerous to build your code like this
    ...
    fallback () public {}
        ...
        if one contract has a default fallback function it would be deadly for the naive contract to refund this contract address
...
contract Victim {
    ...
    function isItAContract() public view returns(bool) {
        ...
        return(size > 0); // if there bytes of code greater than zero then it is a contract! 
    }    
...
// if you call the address from the constructor ther are no byte codes  
